        ...
        <nav className="fixed left-0 h-full flex flex-col w-[250px] bg-white py-2 rounded-md px-2 text-accentdarken leading-tight">
                <div className="flex gap-2 hover:bg-primary hover:text-white cursor-pointer rounded-sm p-2 text-sm">
                    ...
                    <div className="flex flex-col">
                        <div>Dinas Kesehatan Kota Banjarbaru</div>
                        <div>Umum Kepegawaian</div>
                        <div>
                ...
                <ul className="flex flex-grow flex-col items-start gap-6">
                {list.map((item, index) => (
                    <li key={index} className="w-full">
                    <Link href={item.path} 
                    className={`${pathname === item.path ? "bg-primary text-white" : ""} flex gap-2 w-full items-center justify-start py-4 rounded-sm hover:bg-primary hover:text-white cursor-pointer transition-all`}>
                    ...
                    <li className="flex gap-2 w-full items-center justify-start py-4 rounded-sm hover:bg-primary hover:text-white cursor-pointer transition-all">
                        <span className="mx-4">
