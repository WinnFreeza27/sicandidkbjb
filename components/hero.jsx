...
export default function Hero() {
    return (
        ...
        <div className="max-w-[50ch] flex flex-col gap-5">
          ...
          <Link href="/login" className="justify-self-start w-full sm:w-max px-10 py-3 bg-accent text-white rounded-md hover:bg-accentdarken transition-all">Login</Link>
        </div>
        <div>
          <Image
            src="/hero.png"
